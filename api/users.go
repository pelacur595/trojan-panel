...
func UpdateUserPassById(c *gin.Context) {
	...
	if err := service.UpdateUserPassById(userUpdatePassDto.OldPass, userUpdatePassDto.NewPass, userUpdatePassDto.Id); err != nil {
		vo.Fail(err.Error(), c)
		return
	}
	vo.Success(nil, c)
