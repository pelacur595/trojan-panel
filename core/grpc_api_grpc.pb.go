...
type ApiNodeServerServiceClient interface {
	NodeServerState(ctx context.Context, in *NodeServerGroupDto, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *apiNodeServerServiceClient) NodeServerState(ctx context.Context, in *NodeServerGroupDto, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/ApiNodeServerService/NodeServerState", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ApiNodeServerServiceServer interface {
	NodeServerState(context.Context, *NodeServerGroupDto) (*Response, error)
...
func (UnimplementedApiNodeServerServiceServer) NodeServerState(context.Context, *NodeServerGroupDto) (*Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method NodeServerState not implemented")
}
...
func _ApiNodeServerService_NodeServerState_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(NodeServerGroupDto)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ApiNodeServerServiceServer).NodeServerState(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ApiNodeServerService/NodeServerState",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiNodeServerServiceServer).NodeServerState(ctx, req.(*NodeServerGroupDto))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ApiNodeServerService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "NodeServerState",
			Handler:    _ApiNodeServerService_NodeServerState_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "grpc_api.proto",
...
// ApiXrayTemplateServiceClient is the client API for ApiXrayTemplateService service.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://pkg.go.dev/google.golang.org/grpc/?tab=doc#ClientConn.NewStream.
type ApiXrayTemplateServiceClient interface {
	UpdateXrayTemplate(ctx context.Context, in *XrayTemplateDto, opts ...grpc.CallOption) (*Response, error)
}

type apiXrayTemplateServiceClient struct {
	cc grpc.ClientConnInterface
}

func NewApiXrayTemplateServiceClient(cc grpc.ClientConnInterface) ApiXrayTemplateServiceClient {
	return &apiXrayTemplateServiceClient{cc}
}

func (c *apiXrayTemplateServiceClient) UpdateXrayTemplate(ctx context.Context, in *XrayTemplateDto, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/ApiXrayTemplateService/UpdateXrayTemplate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// ApiXrayTemplateServiceServer is the server API for ApiXrayTemplateService service.
// All implementations must embed UnimplementedApiXrayTemplateServiceServer
// for forward compatibility
type ApiXrayTemplateServiceServer interface {
	UpdateXrayTemplate(context.Context, *XrayTemplateDto) (*Response, error)
	mustEmbedUnimplementedApiXrayTemplateServiceServer()
}

// UnimplementedApiXrayTemplateServiceServer must be embedded to have forward compatible implementations.
type UnimplementedApiXrayTemplateServiceServer struct {
}

func (UnimplementedApiXrayTemplateServiceServer) UpdateXrayTemplate(context.Context, *XrayTemplateDto) (*Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateXrayTemplate not implemented")
}
func (UnimplementedApiXrayTemplateServiceServer) mustEmbedUnimplementedApiXrayTemplateServiceServer() {
}

// UnsafeApiXrayTemplateServiceServer may be embedded to opt out of forward compatibility for this service.
// Use of this interface is not recommended, as added methods to ApiXrayTemplateServiceServer will
// result in compilation errors.
type UnsafeApiXrayTemplateServiceServer interface {
	mustEmbedUnimplementedApiXrayTemplateServiceServer()
}

func RegisterApiXrayTemplateServiceServer(s grpc.ServiceRegistrar, srv ApiXrayTemplateServiceServer) {
	s.RegisterService(&ApiXrayTemplateService_ServiceDesc, srv)
}

func _ApiXrayTemplateService_UpdateXrayTemplate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(XrayTemplateDto)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ApiXrayTemplateServiceServer).UpdateXrayTemplate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ApiXrayTemplateService/UpdateXrayTemplate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiXrayTemplateServiceServer).UpdateXrayTemplate(ctx, req.(*XrayTemplateDto))
	}
	return interceptor(ctx, in, info, handler)
}

// ApiXrayTemplateService_ServiceDesc is the grpc.ServiceDesc for ApiXrayTemplateService service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var ApiXrayTemplateService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "ApiXrayTemplateService",
	HandlerType: (*ApiXrayTemplateServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "UpdateXrayTemplate",
			Handler:    _ApiXrayTemplateService_UpdateXrayTemplate_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "grpc_api.proto",
