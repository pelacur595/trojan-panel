...
type ApiNodeServiceClient interface {
	AddNode(ctx context.Context, in *NodeAddDto, opts ...grpc.CallOption) (*NodeResponse, error)
	RemoveNode(ctx context.Context, in *NodeRemoveDto, opts ...grpc.CallOption) (*NodeResponse, error)
}
...
func (c *apiNodeServiceClient) AddNode(ctx context.Context, in *NodeAddDto, opts ...grpc.CallOption) (*NodeResponse, error) {
...
func (c *apiNodeServiceClient) RemoveNode(ctx context.Context, in *NodeRemoveDto, opts ...grpc.CallOption) (*NodeResponse, error) {
	out := new(NodeResponse)
...
type ApiNodeServiceServer interface {
	AddNode(context.Context, *NodeAddDto) (*NodeResponse, error)
	RemoveNode(context.Context, *NodeRemoveDto) (*NodeResponse, error)
...
func (UnimplementedApiNodeServiceServer) AddNode(context.Context, *NodeAddDto) (*NodeResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddNode not implemented")
}
func (UnimplementedApiNodeServiceServer) RemoveNode(context.Context, *NodeRemoveDto) (*NodeResponse, error) {
