...
func SelectSystemByName(name *string) (*vo.SystemVo, error) {
	get := redis.RedisClient.String.Get("trojan-panel:system")
	...
	if err := get.ScanStruct(systemVo); err != nil {
		...
		redis.RedisClient.String.Set("trojan-panel:system", systemVo, time.Hour.Milliseconds()*2)
		return systemVo, nil
	}
	return systemVo, nil
}
...
func UpdateSystemById(system *module.System) error {
	...
	redis.RedisClient.Key.Del("trojan-panel:system")
	return nil
}
